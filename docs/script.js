...
(function() {
  ...
  var translations = {
    en: {
      ...
      "demo.subtitle": "Screenshots from the actual extension in use.",
      "demo.1.caption": "The native download button is now visible in the media viewer.",
      "demo.2.caption": "The same works inside Stories.",
    ...
    es: {
      ...
      "demo.subtitle": "Capturas de pantalla de la extensión en uso real.",
      "demo.1.caption": "El botón de descarga nativo ahora es visible en el visor multimedia.",
      "demo.2.caption": "Lo mismo funciona dentro de Stories.",
